...
import com.itworksonmymachine.eduamp.EduampApplication;
import com.itworksonmymachine.eduamp.controller.GenericTokenController;
...
@SpringBootTest(classes = {EduampApplication.class,
    GenericTokenController.class}, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@AutoConfigureMockMvc
public class GenericTokenControllerIntegrationTest {

  @Autowired
  private GenericTokenController sut;
  ...
  private List<String> retrieveTokens() throws Exception {
    return mapper.readValue(
        mockMvc.perform(get("/tokens")).andExpect(status().isOk()).andReturn().getResponse()
