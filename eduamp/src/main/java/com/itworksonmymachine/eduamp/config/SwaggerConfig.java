...
@Configuration
@EnableSwagger2
@ComponentScan(basePackages = "com.itworksonmymachine.eduamp")
public class SwaggerConfig {
  ...
  public Docket productApi() {
    ...
    return new Docket(DocumentationType.SWAGGER_2)
        .select()
        .apis(RequestHandlerSelectors.basePackage("com.itworksonmymachine")).paths(regex("/.*"))
  ...
  public SecurityConfiguration security() {
    return new SecurityConfiguration
        ("client", "secret", "", "", "Bearer access token", ApiKeyVehicle.HEADER,
